...
# This function is used to convert the boxes into the format of (top-left-corner, bottom-right-corner).
...
def draw_outputs(img, boxes, objectness, classes, nums, class_names):
    ...
    # crate obj_name dictionary variable to store detected objects
    obj_name = {}
    ...
    for i in range(nums):
        ...
        obj_name[class_names[int(classes[i])]] = objectness[i]
    return img, obj_name
